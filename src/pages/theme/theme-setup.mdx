...
```js
export default {
  title: `Buillt Astro Theme | A Marketing Website Theme for Startups and Businesses`,
  description: `A simple, clean, and modern theme a startup or businesses' marketing website.`,
  url: `https://Buillt.ch`, // No trailing slash!
...
The easiest way to swap out the Buillt logo across the site is to replace this code with the SVG code for your company's logo or using an `<img>` tag linked to your company logo.

You should see that the Buillt logo changes across the theme once this is updated.
...
Buillt Theme will automatically generate a `sitemap.xml` file for you using Astro's `@astrojs/sitemap` integration. 
