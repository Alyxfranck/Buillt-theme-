export default {
	title: `Buillt Demo | A Marketing Website Theme for Startups and Businesses`,
	...
	name: `Buillt`, // The short name of the business or brand name. Used for things like the copyright in the footer.
